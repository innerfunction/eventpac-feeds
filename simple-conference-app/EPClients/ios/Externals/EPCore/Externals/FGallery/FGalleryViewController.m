...
{
    int barHeight = 0;
    /* INFU edit 20130524 - this calculation doesn't appear to be necessary, causes the thumbnail view to be
       displayed with a gap between it and the top of the screen.
